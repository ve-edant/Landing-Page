...
export const servicesData = [
  {
    ...
    description:
      "Daflitech leads the way in blockchain development, offering businesses secure, scalable, and efficient blockchain-based solutions. We help companies integrate decentralized technologies to streamline processes, enhance transparency, and improve security.",
    subpoints: [
