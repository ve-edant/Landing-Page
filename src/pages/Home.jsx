...
const Home = () => {
  return (
    <div className="relative min-h-screen w-full bg-white text-black z-5">
      <div
      ...
      <div className=" relative max-w-screen-xl z-10 mx-auto md:mx-32 flex flex-col md:flex-row items-center justify-between px-4 py-0 md:py-6 gap-10">
        ...
        <div
          id="animation"
          className="w-full md:w-1/2 h-[90vh] md:h-[500px] bg-yellow-100 flex items-center justify-center rounded-lg"
        >
        ...
        <div
          id="hero-content"
          className="w-full md:w-1/2 flex flex-col gap-3 md:text-left"
        >
