    ...
    <header className="w-full fixed top-0 left-0 z-50 bg-white border-b border-black shadow-md">
      <div className="max-w-screen-xl mx-0 md:mx-10 lg:mx-32 flex flex-col px-4">
        ...
        >
          ...
          <div className="max-w-screen-xl mx-auto h-[120px] pb-4 w-full flex gap-4">
              ...
              <div>
                ...
                <div
                  className={`
                    ...
                    ${mobileDropdown === "services" ? "max-h-screen opacity-100 pt-2" : "max-h-0 opacity-0"}
                  `}
                >
                  <DropdownCard
                    to="/design"
              ...
              <div>
                ...
                <div
                  className={`
                    pl-0 md:pl-4 mt-2 flex flex-col gap-2
                    overflow-hidden transition-all duration-300 ease-in-out
                    ${mobileDropdown === "about" ? "max-h-screen opacity-100 pt-2" : "max-h-0 opacity-0"}
                  `}
                >
                  <DropdownCard
                    to="/aboutus"
